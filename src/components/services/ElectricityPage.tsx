...
const ElectricityPage: React.FC<ElectricityPageProps> = ({ user, onLogout }) => {
  ...
  const discos = [
    { id: 'eko', name: 'Eko Electric', color: 'bg-blue-600' },
    { id: 'ikeja', name: 'Ikeja Electric', color: 'bg-green-600' },
    { id: 'abuja', name: 'Abuja Electric', color: 'bg-purple-600' },
    { id: 'kano', name: 'Kano Electric', color: 'bg-red-600' },
    { id: 'portharcourt', name: 'Port Harcourt Electric', color: 'bg-yellow-600' },
    { id: 'ibadan', name: 'Ibadan Electric', color: 'bg-indigo-600' }
  ];
  ...
  const handleMeterNumberChange = (value: string) => {
    ...
    setErrors(prev => ({ ...prev, meterNumber: error }));
  };
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              {discos.map((disco) => (
                ...
                >
                  <div className={`w-8 h-8 ${disco.color} rounded-lg mb-2`}></div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-3xl p-6 w-full max-w-sm">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">Please review your electricity bill payment</p>
              </div>
