...
const DataPage: React.FC<DataPageProps> = ({ user, onLogout }) => {
  ...
  const selectedPlanDetails = selectedNetwork && selectedPlan 
    ? dataPlans[selectedNetwork as keyof typeof dataPlans]?.find(p => p.id === selectedPlan)
    : null;
            ...
            <div className="bg-white rounded-3xl p-6 w-full max-w-sm">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{selectedPlanDetails.validity}</span>
                </div>
                <div className="flex justify-between">
