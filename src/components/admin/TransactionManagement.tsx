...
const TransactionManagement: React.FC = () => {
	...
	const filteredTransactions = transactions.filter((transaction) => {
		...
		const matchesService =
			serviceFilter === "all" || transaction.service_type === serviceFilter;
									...
									>
										...
										<td className="px-6 py-4 whitespace-nowrap">
											<div className="flex items-center space-x-2">
												<ServiceIcon
													className={`w-5 h-5 ${getServiceColor(transaction.service_type)}`}
												/>
										...
										<td className="px-6 py-4 whitespace-nowrap">
											<span
												className={`inline-flex items-center space-x-1 px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(transaction.status)}`}
											>
				...
				<div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-neutral-900/50 backdrop-blur-sm">
					...
					>
						<div className="p-6 border-b border-neutral-200">
							<div className="flex items-center justify-between">
								<h3 className="text-xl font-ginto font-semibold text-neutral-900">
									Transaction Details
								</h3>
								<button
						...
						<div className="p-6 space-y-6">
							...
							<div className="flex items-center justify-between">
								<div className="flex items-center space-x-3">
									{React.createElement(
										getServiceIcon(selectedTransaction.service_type),
										{
								...
								<span
									className={`inline-flex items-center space-x-1 px-3 py-1 text-sm font-medium rounded-full ${getStatusColor(selectedTransaction.status)}`}
								>
									{React.createElement(
